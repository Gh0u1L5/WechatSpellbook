...
interface IXmlParserHook {
     ...
     * @return to bypass the original method, return [Operation.interruption] or a
     * MutableMap<String, String> object wrapped by [Operation.replacement], otherwise return
     * [Operation.nop].
     */
